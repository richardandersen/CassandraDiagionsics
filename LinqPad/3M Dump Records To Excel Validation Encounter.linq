...
void Main()
{
	...
	var connectionStringV2 = "Contact Points=192.168.190.139";//"Contact Points=127.0.0.1"; WIN-DCE2X-3M; 192.168.190.134;169.10.60.206
	
	var targetFilePath = @"D:\Projects\DataStax\Projects\3M\Excel Validation\Encounter Validation.xlsm"; //xlsx;
	
	var cqlV1_1 = "select blobasText(key), blobasText(column1), blobasText(value) from \"KSV1_VOLATILE\".\"EncounterAudit\";"; //KS055298 
	//var cqlV1_2 = "select blobasText(key), blobasText(column1), blobasText(value) from \"KSV1_VOLATILE\".\"Encounter\";";
	var cqlV1_2 = "select key, column1, value from \"KSV1_VOLATILE\".\"Encounter\";"; 
	var cqlV1_3 = "select blobasText(key), blobasText(column1), blobasText(value) from \"KSV1_VOLATILE\".\"idxEncIdDocument\";"; 
	
	var excelWorkSheetNameV1_1 = "V1.EncounterAudit";
	var excelWorkSheetNameV1_2 = "V1.Encounter";
	var excelWorkSheetNameV1_3 = "V1.idxEncIdDocument";
	
	var cqlV2_1 = "select * from v2_volatile.encounter;";  //v2_volatile
	var cqlV2_2 = "select * from v2_volatile.encounterbydischargedate;"; 
	var cqlV2_3 = "select * from v2_volatile.encounterbyvisit;"; 
	var cqlV2_4 = "select * from v2_volatile.encountersupportingdocument;"; 
	
	var excelWorkSheetNameV2_1 = "V2.encounter";
	var excelWorkSheetNameV2_2 = "V2.encounterbydischargedate";
	var excelWorkSheetNameV2_3 = "V2.encounterbyvisit";
	var excelWorkSheetNameV2_4 = "V2.encountersupportingdocument";
	...
	using (var sessionV2 = clusterV2.Connect())
	{
		ReadThriftRowIntoRecordsSaveToExcel(excelPkg,
											sessionV1,
											cqlV1_1,
											excelWorkSheetNameV1_1);
											
		ReadThriftRowIntoRecordsSaveToExcel(excelPkg,
											sessionV1,
											cqlV1_2,
											excelWorkSheetNameV1_2);
		
		ReadThriftRowIntoRecordsSaveToExcel(excelPkg,
											sessionV1,
											cqlV1_3,
											excelWorkSheetNameV1_3,
											true);
											
		ReadCQLSaveToExcel(excelPkg,
							sessionV2,
							cqlV2_1,
							excelWorkSheetNameV2_1);
							
		ReadCQLSaveToExcel(excelPkg,
							sessionV2,
							cqlV2_2,
							excelWorkSheetNameV2_2);
							
		ReadCQLSaveToExcel(excelPkg,
							sessionV2,
							cqlV2_3,
							excelWorkSheetNameV2_3);
							
		ReadCQLSaveToExcel(excelPkg,
							sessionV2,
							cqlV2_4,
							excelWorkSheetNameV2_4);
