...
void Main()
{
	var connectionString = "Contact Points=192.168.58.131";//"Contact Points=127.0.0.1"; WIN-DCE12X-3M
	var cqlString = "select blobastext(key), blobastext(column1), blobastext(value) from \"KSV1_VOLATILE\".\"ChangeHx\";"; //KS055298 
	//var cqlString = "select key, column1, value from \"KSV1_VOLATILE\".\"EncounterAudit\";"; //KS055298 
	var excelWorkSheetName = "ChangeHx";

	var targetFilePath = @"D:\Projects\DataStax\Projects\3M\ChangeHx Dump.xlsx";
